...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(secondary-selection ((,class (:background ,"gray80"))))
   ...
   `(isearch-fail ((,class (:foreground ,failure :normal t))))
   `(lazy-highlight
     ((,class (:foreground ,foreground :background ,region))))

   ;; ido-mode
   `(ido-subdir ((,class (:foreground ,foreground :weight normal))))
   `(ido-only-match ((,class (:foreground ,foreground :weight normal))))

   ;; show-paren
   `(show-paren-match
     ((,class (:background ,"gray80"))))
   `(show-paren-mismatch
     ((,class (:foreground ,failure :weight normal))))
   ...
   `(mode-line
     ...
     `(org-warning ((,class (:background ,region :foreground ,foreground :weight normal))))
     `(org-todo ((,class (:background ,region :foreground ,foreground :weight normal))))
     `(org-done ((,class (:background ,region :foreground ,foreground :weight normal))))
     ...
     `(org-block-begin-line
       ((,class (:background ,org-background :foreground ,comment-delimiter :weight normal))))
     `(org-block-end-line
       ((,class (:background ,org-background :foreground ,comment-delimiter :weight normal))))

     ;; js2-mode
     `(js2-external-variable ((,class (:inherit base-faces :weight normal))))
     ...
     `(js2-jsdoc-type ((,class (:inherit base-faces :weight normal))))
